...
def parse_args_pool():
    ...
    parser.add_argument('--fig_save_dir', type=str, default='./Output_file/fig/Politics/')
    parser.add_argument('--rst_save_dir', type=str, default='./Output_file/rst/Politics/')
    # parser.add_argument('--hidden', type=int, default=8, help='Number of hidden units.')
    parser.add_argument('--BATCH_SIZE', type=int, default=300, help='Number of batch size in each iteration.')
    parser.add_argument('--MAX_ITER', type=int, default=179, help='Maximum iterations in a training set.')
    ...
    parser.add_argument('--node_num', type=int, default=2723, help='Number of nodes.')
    parser.add_argument('--embed_size', type=int, default=128, help='Number of nodes.')
    parser.add_argument('--cluster', type=str, default='Politics', help='cluster type')
...
#                 t_predict = cur_time + (t_next / args.PREDICT_N)
    ...
    with open(args.rst_save_dir + 'Politics_dict_of_set' + '.pkl', 'wb') as f:
        pickle.dump(dict_of_set, f, pickle.HIGHEST_PROTOCOL)
    with open(args.rst_save_dir + 'Politics_dict_of_node' + '.pkl', 'wb') as f:
...
#     train_data = train_data[0:600]
    ...
    for epoch in range(args.epochs):
        log_dir = './dyrep_Politics_para.pkl'
        model_dir = './Politics_model.pkl'
